...
class PrimesSieveParallelMultiplesOptimizedOpenMPITimeAndCacheWithWheel: public PrimesSieveParallelMultiplesOptimizedOpenMPI<FlagsContainer, WheelType> {
	...
	public:
		...
		virtual void initPrimesBitSetSizeForSieving(size_t blockSize) {
			this->PrimesSieve<FlagsContainer>::template initPrimesBitSetSize(blockSize);
		}
		...
		inline size_t getProcessBitsetSize(size_t processID, size_t numberProcesses, size_t maxRange) {
