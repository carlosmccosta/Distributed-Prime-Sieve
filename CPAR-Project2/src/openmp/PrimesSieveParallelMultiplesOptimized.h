...
class PrimesSieveParallelMultiplesOptimized: public PrimesSieve<FlagsContainer> {
	protected:
		size_t _blockSizeInElements;

	public:
		PrimesSieveParallelMultiplesOptimized(size_t blockSizeInElements = 128 * 1024) :
				_blockSizeInElements(blockSizeInElements) {
		}

		virtual ~PrimesSieveParallelMultiplesOptimized() {
		}
