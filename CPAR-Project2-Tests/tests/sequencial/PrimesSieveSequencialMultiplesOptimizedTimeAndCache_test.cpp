...
BOOST_AUTO_TEST_SUITE(PrimesSieveSequencialMultiplesOptimizedTimeAndCache_test)
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks10) {
		PrimesSieveSequencialMultiplesOptimizedTimeAndCache<vector<char> > primesSieveSequencialMultiples(64*10/8); // 10 elements block
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks32) {
		PrimesSieveSequencialMultiplesOptimizedTimeAndCache<vector<char> > primesSieveSequencialMultiples(64*32/8); // 32 elements block
		primesSieveSequencialMultiples.computePrimes(7919);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedTimeAndCachePrimes1000_Blocks10.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks100) {
		PrimesSieveSequencialMultiplesOptimizedTimeAndCache<vector<char> > primesSieveSequencialMultiples(64*100/8); // 100 elements block
		primesSieveSequencialMultiples.computePrimes(7919);
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks1000) {
		PrimesSieveSequencialMultiplesOptimizedTimeAndCache<vector<char> > primesSieveSequencialMultiples(64*1000/8); // 1000 elements block
		primesSieveSequencialMultiples.computePrimes(7919);
