...
BOOST_AUTO_TEST_SUITE(PrimesSieveSequencialMultiplesOptimizedSpaceTimeAndCacheWithModulo30Wheel_test)
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks10) {
		...
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedSpaceTimeAndCacheWithModulo30WheelPrimes1000_Blocks10.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks32) {
		...
		primesSieveSequencialMultiples.computePrimes(7926);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedSpaceTimeAndCacheWithModulo30WheelPrimes1000_Blocks32.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks100) {
		...
		primesSieveSequencialMultiples.computePrimes(7926);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedSpaceTimeAndCacheWithModulo30WheelPrimes1000_Blocks100.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks1000) {
		...
		primesSieveSequencialMultiples.computePrimes(7926);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedSpaceTimeAndCacheWithModulo30WheelPrimes1000_Blocks1000.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks2000) {
		...
		primesSieveSequencialMultiples.computePrimes(7926);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/optimizedSpaceTimeAndCacheWithModulo30WheelPrimes1000_Blocks2000.txt");
