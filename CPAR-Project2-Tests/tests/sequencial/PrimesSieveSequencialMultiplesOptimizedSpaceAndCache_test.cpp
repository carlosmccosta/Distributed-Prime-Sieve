...
BOOST_AUTO_TEST_SUITE(PrimesSieveSequencialMultiplesOptimizedSpaceAndCache_test)
	BOOST_AUTO_TEST_CASE(compute100Primes) {
		...
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/v3primes100.txt");
	...
	BOOST_AUTO_TEST_CASE(compute1000Primes) {
		PrimesSieveSequencialMultiplesOptimizedSpaceAndCache<vector<bool> > primesSieveSequencialMultiples(20);
		primesSieveSequencialMultiples.computePrimes(7919);
		primesSieveSequencialMultiples.savePrimesToFile("tests/testresults/v3primes1000.txt");
