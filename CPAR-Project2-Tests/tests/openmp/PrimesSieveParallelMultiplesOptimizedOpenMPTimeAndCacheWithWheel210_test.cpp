...
BOOST_AUTO_TEST_SUITE(PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithModulo210Wheel_test)
	BOOST_AUTO_TEST_CASE(compute100Primes) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples;
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks1byte) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples(1);   // 8 elements block
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks4byte) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples(4);   // 32 elements block
		primesSieveParallelMultiples.computePrimes(7926);
	...
	BOOST_AUTO_TEST_CASE(compute1000PrimesBlocks16byte) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples(16);   // 128 elements block
		primesSieveParallelMultiples.computePrimes(7926);
	...
	BOOST_AUTO_TEST_CASE(compute100000PrimesBlocks128byte) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples(128);   // 1024 elements block
	...
	BOOST_AUTO_TEST_CASE(compute100000PrimesBlocks512byte) {
		PrimesSieveParallelMultiplesOptimizedOpenMPTimeAndCacheWithWheel<PrimesFlagsContainer, Modulo210Wheel> primesSieveParallelMultiples(512);   // 4096 elements block
		primesSieveParallelMultiples.computePrimes(1299828);
